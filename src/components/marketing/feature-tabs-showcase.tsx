  ...
  return [
    {
      ...
      label: "App blocking",
      icon: Smartphone,
      title: "Silence the apps that steal your attention",
      description:
        "Schedule blocks for social, games, and messaging. Quick exceptions when you need them — without undoing your whole day.",
      proof: "Most people block 3–5 apps in their first session.",
    ...
    },
    {
      ...
      label: "Focus modes",
      icon: Zap,
      title: "One tap for work, study, or sleep",
      description:
        "Switch rule sets instantly. Pauseward applies the right blocks and schedules for the moment — no digging through settings.",
    ...
    },
    {
      ...
      icon: Globe,
      title: "Cut off feeds and rabbit holes at the source",
      description:
        "Block distracting sites and adult content network-wide — not just in one browser tab that's easy to bypass.",
    ...
    },
    {
      ...
      description:
        "Clean analytics show daily patterns, top distractions, and focus streaks — so you can change habits with data, not guilt.",
      proof: "50K+ hours of focus tracked across Pauseward users.",
